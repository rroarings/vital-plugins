...
public class TalkToAccountGuide2 implements ScriptTask
{
    private final WorldPoint master_chef_point = new WorldPoint(3126, 3124, 0);

    VitalQuesterConfig config;

    public TalkToAccountGuide2(VitalQuesterConfig config)
    {
        this.config = config;
    }
    ...
    public boolean validate()
    {
        ...
        if(widget != null) {
            ...
            if(widget_child != null) {
                return widget_child.getText().contains("This is your Account Management");
            }
        }
        return false;
    }
